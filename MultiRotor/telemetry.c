...
void send_residual_data(void)
{
	...
	{
		start_residuals = 0 ;
		serial_output("\r\n\r\nimu_temp_yy,calibrating_yy,x_force_yy,y_force_yy,z_force_yy,x_rate16_yy,y_rate16_yy,z_rate16_yy,rms_rate16_yy,x_flt16_yy,y_flt16_yy,z_flt16_yy,net_dev_yy,tilt_adj(degs)_yy,pending_uploads_yy\r\n") ;
    }
	else
	{
        ...
        if((TURTLE_TESTING==0)||(log_jostle==1))
        {
            if (TURTLE_TESTING==1)
            {
                serial_output("%i,%i,%li,%li,%li,%li,%li,%li,%i,%li,%li,%li,%i,%.3f,%i\r\n",  
                    mpu_temp.value,
                    log_jostle ,
                    accel_sum[0],
                    accel_sum[1],
            ...
            {
                serial_output("%i,%i,%.1f,%.1f,%.1f,%li,%li,%li,%i,%li,%li,%li,%i,%.3f,%i\r\n",  
                    mpu_temp.value,
                    log_jostle ,
