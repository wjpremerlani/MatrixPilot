...
#ifndef options_LUGE7_SN161_H
#define	options_LUGE7_SN161_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( -5 )
#define YACCEL_OFFSET	( -53 )
#define ZACCEL_OFFSET	( -25 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn161.h"
