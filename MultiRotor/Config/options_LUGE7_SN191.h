...
#ifndef options_LUGE7_SN191_H
#define	options_LUGE7_SN191_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( 12 )
#define YACCEL_OFFSET	( -40 )
#define ZACCEL_OFFSET	( 1 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn191.h"
