...
#ifndef options_LUGE7_SN141_H
#define	options_LUGE7_SN141_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( -15 )
#define YACCEL_OFFSET	( -58 )
#define ZACCEL_OFFSET	( 35 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn141.h"
