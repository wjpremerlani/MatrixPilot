...
#ifndef options_LUGE7_SN177_H
#define	options_LUGE7_SN177_H

#define CUSTOM_OFFSETS
//#define XACCEL_OFFSET	( 0 )
//#define YACCEL_OFFSET	( -34 )
//#define ZACCEL_OFFSET	( -38 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn177.h"
