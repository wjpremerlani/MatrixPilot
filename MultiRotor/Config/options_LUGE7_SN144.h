...
#ifndef options_LUGE7_SN144_H
#define	options_LUGE7_SN144_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( -23 )
#define YACCEL_OFFSET	( -31 )
#define ZACCEL_OFFSET	( 2 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn144.h"
