...
#ifndef options_LUGE7_SN178_H
#define	options_LUGE7_SN178_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( -1 )
#define YACCEL_OFFSET	( -50 )
#define ZACCEL_OFFSET	( -6 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn178.h"
...
#define CAL_GRAV_Z	4091

#endif	/* options_LUGE7_SN178_H */
