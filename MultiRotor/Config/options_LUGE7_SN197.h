...
#ifndef options_LUGE7_SN197_H
#define	options_LUGE7_SN197_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( -6 )
#define YACCEL_OFFSET	( -36 )
#define ZACCEL_OFFSET	( -13 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn197.h"
