...
#ifndef options_LUGE7_SN146_H
#define	options_LUGE7_SN146_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( 11 )
#define YACCEL_OFFSET	( -47 )
#define ZACCEL_OFFSET	( -4 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn146.h"
