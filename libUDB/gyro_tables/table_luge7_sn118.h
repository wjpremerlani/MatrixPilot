...
// used in LUGE7_SN118 partition size 64
...
int16_t residual_offset[] = { 716 -677 , -237 +435 , -196+158 } ;
...
#define ACCEL_TABLE_ORIGIN ( -11276)

int16_t accel_residual_offset[] = { 4+2,-27-3,-63-3 } ; 
