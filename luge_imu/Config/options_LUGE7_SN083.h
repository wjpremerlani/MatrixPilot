...
#ifndef options_LUGE7_SN083_H
#define	options_LUGE7_SN083_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( -16 )
#define YACCEL_OFFSET	( -37 )
#define ZACCEL_OFFSET	( 80 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn083.h"
