...
#ifndef options_LUGE7_SN170_H
#define	options_LUGE7_SN170_H

#define CUSTOM_OFFSETS
#define XACCEL_OFFSET	( -7 )
#define YACCEL_OFFSET	( -21 )
#define ZACCEL_OFFSET	( 9 )
#define GYRO_OFFSET_TABLE "../libUDB/gyro_tables/table_luge7_sn170.h"
