...
const struct waypointDef waypoints[] = {
	...
	{ { -738049639, 427535031, 0 } , LANDING_SPEED , 50 , F_ABSOLUTE + F_LAND + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 6
	{ { -738041978, 427365470, -20 } , LANDING_SPEED , 50 , F_ABSOLUTE + F_LAND + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 7
