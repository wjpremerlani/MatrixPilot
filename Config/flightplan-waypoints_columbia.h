...
const struct waypointDef waypoints[] = {
	...
	{ { -738049639, 427535031, 0 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 5
	{ { -738041337, 427347505, 0 } , F_ABSOLUTE + F_LAND + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 6
};
