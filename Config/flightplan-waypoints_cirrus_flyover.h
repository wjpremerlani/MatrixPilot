...
*/
const struct waypointDef waypoints[] = {
	{ { -738146403, 431230295, 1219 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 1
	{ { -738103019, 429509530, 1219 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 2
	{ { -738078181, 428556789, 600 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 3
	{ { -738052027, 427597964, 10 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 4
	{ { -738049639, 427535031, 10 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 5
	{ { -738041336, 427347504, 200 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 6
	{ { -738018646, 426355035, 400 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 7
	{ { -735883179, 426360087, 600 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 8
	{ { -735787048, 427470414, 800 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 9
};
