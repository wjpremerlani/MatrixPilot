...
const struct waypointDef waypoints[] = {
	...
	{ { -738052027, 427597964, 10 } , 85 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 4
	{ { -738049639, 427535031, 10 } , 85 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 5	
	{ { -738041336, 427347504, 200 } , 120 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 6
	{ { -738018646, 426355035, 400 } , 120 , 0 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 7
	{ { -735883179, 426360087, 600 } , 120 , 0 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 8
	{ { -735787048, 427470414, 800 } , 120 , 0 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 9
};
...
const struct waypointDef rtlWaypoints[] = {
	...
	{ { -738078181, 428556789, 600 } , 85 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 3
	{ { -738052027, 427597964, 10 } , 85 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 4
	{ { -738049639, 427535031, 10 } , 85 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 5	{ { -738041336, 427347504, 200 } , 110 , 50 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 6
	{ { -738018646, 426355035, 400 } , 120 , 0 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 7
	{ { -735883179, 426360087, 600 } , 120 , 0 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 8
	{ { -735787048, 427470414, 800 } , 120 , 0 , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 9
};
