...
const struct waypointDef waypoints[] = {
	...
	{ { 155, 20, 45 } , 10 , 0 , F_NORMAL + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 10
	{ { 165, -52, 30 } , 10 , 0 , F_NORMAL , CAM_VIEW_LAUNCH } , //Waypoint 11
	{ { 94, -65, 20 } , 10 , 0 , F_NORMAL , CAM_VIEW_LAUNCH } , //Waypoint 12
	{ { -5, 3, 10 } , 10 , 0 , F_NORMAL + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 13
	{ { -125, 105, -5 } , 0 , 0 , F_LAND + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 14
};
